-- 1. Get unique fund houses, categories, sub-categories, and risk grades(Select wanted files)
SELECT DISTINCT fund_house, category, sub_category, risk_grade FROM fund_master;

-- 2. Verify all scheme codes in fund_master have historical NAV data(Verification)
...
-- 3. Calculate min, max, and average NAV for each scheme(Function)
